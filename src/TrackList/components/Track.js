...
import { loadTrack } from '../../Player/actions'
import { fillNextUp } from "../../UpNext/actions"
...
class Track extends React.Component {
  handleDoubleClick() {
    ...
    this.props.dispatch(fillNextUp(this.props.playlist.slice(1, this.props.playlist.length)));
  }
